...
class PlatformAdminUsersListForm(StripWhitespaceForm):
    ...
    take_part_on_research = GovukRadiosField(
    ...
    def validate(self, extra_validators=None):
        if not (
            ...
            or self.take_part_on_research.data
            or self.permissions_field.data
        ):
            self.take_part_on_research.errors = ("You must provide at least one filter option",)
            return False
